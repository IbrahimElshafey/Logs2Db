...
//public class LogFilesAggregatorBase<ResultType, LineProcessingResult>
//{
//    private readonly int _bulkReadSize;
//private readonly int _concurrency;
//private readonly ILogLineProcessor<LineProcessingResult> _hasher;
...
//public LogFilesAggregatorBase(ILogLineProcessor<LineProcessingResult> hasher, int concurrency, int? maxQueueSize = null, int bulkReadSize = 100)
//{
//    if (concurrency <= 0)
...
//public async Task<ResultType> AggregateLogFilesAsync(string[] logFiles, IProgress<int>? progress = null)
//{
...
//    var globalResults = new ConcurrentDictionary<LineProcessingResult, ResultType>(new ByteArrayComparer());
